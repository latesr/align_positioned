...
class _RenderAlignPositionedBox extends RenderShiftedBox {
  ...
  void _checkConstraints() {
    if (constraints.maxWidth == double.infinity)
      throw FlutterError.fromParts(<DiagnosticsNode>[
        ...
        ErrorDescription('This probably means it is inside of a widget which lets its width be as large as it wants. '
    ...
    if (constraints.maxHeight == double.infinity)
      throw FlutterError.fromParts(<DiagnosticsNode>[
        ...
        ErrorDescription('This probably means it is inside of a widget which lets its height be as large as it wants. '
  ...
  void alignChild() {
    assert(child != null);
    assert(child?.debugNeedsLayout == false);
    assert(child?.hasSize == true);
    assert(hasSize);
    // ---
  ...
  Matrix4 get _effectiveTransform {
    ...
    if (_origin == null) return transform;
    final Matrix4 result = Matrix4.identity();
    if (_origin != null) result.translate(_origin!.dx, _origin!.dy);
    Offset translation = resolvedAlignment.alongSize(size);
