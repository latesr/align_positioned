...
class AnimatedAlignPositioned extends ImplicitlyAnimatedWidget {
  ...
  /// Position.
  final double dx, dy, moveByChildWidth, moveByChildHeight, moveByContainerWidth, moveByContainerHeight;
...
class _AnimatedAlignPositionedState //
  ...
  Widget build(BuildContext context) {
    return AlignPositioned(
      ...
      dx: _dx?.evaluate(animation!) as double,
      dy: _dy?.evaluate(animation!) as double,
      moveByChildWidth: _moveByChildWidth?.evaluate(animation!) as double,
      moveByChildHeight: _moveByChildHeight?.evaluate(animation!) as double,
      moveByContainerWidth: _moveByContainerWidth?.evaluate(animation!) as double,
      moveByContainerHeight: _moveByContainerHeight?.evaluate(animation!) as double,
      moveVerticallyByChildWidth: _moveVerticallyByChildWidth?.evaluate(animation!) as double,
      moveHorizontallyByChildHeight: _moveHorizontallyByChildHeight?.evaluate(animation!) as double,
      moveVerticallyByContainerWidth: _moveVerticallyByContainerWidth?.evaluate(animation!) as double,
      moveHorizontallyByContainerHeight: _moveHorizontallyByContainerHeight?.evaluate(animation!) as double,
